...
export default function Cruceros() {
  ...
  const proximasSalidas = items.filter(c => new Date(c.fechaSalida) > today).length;
  const capacidadPromedio = items.length > 0
    ? Math.round(items.reduce((sum, c) => sum + Number(c.capacidad || 0), 0) / items.length)
    : 0;
              ...
              <div className="package-body">
                ...
                <div className="package-info">
                  ...
                  <div className="info-item">
                    ...
                    <span>{item.duracion} noches - {formatDate(item.fechaSalida)}</span>
                  </div>
                  <div className="info-item">
                    <span className="info-icon">
                      <FaDollarSign />
              ...
              <div className="package-footer">
                <div className="package-price">
                  ...
                  <span className="price-value">
                    {Array.isArray(item.itinerario) ? item.itinerario.length : 0} puertos
                  </span>
                </div>
              </div>
            </div>
