        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 leading-tight">
            ...
            <span className="text-primary relative">
              Agencias de Viajes
              <svg className="absolute -bottom-2 left-0 w-full h-3 text-primary/20" viewBox="0 0 200 12" fill="none" preserveAspectRatio="none">
                <path d="M2 7 Q50 2, 100 7 T198 7" stroke="currentColor" strokeWidth="4" fill="none" strokeLinecap="round"/>
              </svg>
            </span>
          </h1>
          ...
          <p className="text-xl sm:text-2xl text-gray-600 font-medium">
            Un solo lugar, múltiples agencias. <span className="text-primary font-semibold">Vos elegís.</span>
          </p>
        </div>
