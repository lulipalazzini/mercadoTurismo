...
export default function ModuleFilters({ module, onFiltersChange }) {
  ...
  const getModuleFields = () => {
    switch (module) {
      case "paquetes":
        return [
          { key: "destino", label: "Destino", type: "text", placeholder: "Ej: París, Roma..." },
      ...
      case "cruceros":
        return [
          { key: "puertoSalida", label: "Puerto de salida", type: "text", placeholder: "Ej: Buenos Aires" },
          { 
            key: "mes", 
            label: "Mes de salida", 
            type: "select",
          ...
          { key: "duracionMin", label: "Duración mínima (días)", type: "number", min: 1 },
          { key: "duracionMax", label: "Duración máxima (días)", type: "number", min: 1 },
          { 
            key: "moneda", 
            label: "Moneda", 
            type: "select",
      ...
      case "alojamientos":
        return [
          { key: "ubicacion", label: "Ubicación", type: "text", placeholder: "Ciudad o región" },
          ...
          { key: "precioMax", label: "Precio por noche (max)", type: "number", min: 0 },
        ];
      
      case "autos":
        return [
          { key: "ubicacion", label: "Ubicación", type: "text", placeholder: "Ciudad o aeropuerto" },
          ...
          { key: "capacidad", label: "Pasajeros", type: "number", min: 1, max: 15 },
          { 
            key: "transmision", 
            label: "Transmisión", 
            type: "select",
      ...
      case "excursiones":
        return [
          { key: "destino", label: "Destino", type: "text", placeholder: "¿Dónde?" },
          { 
            key: "tipo", 
            label: "Tipo", 
            type: "select",
          ...
          { key: "duracion", label: "Duración (horas)", type: "number", min: 1 },
          { key: "precioMax", label: "Precio máximo", type: "number", min: 0 },
        ];
      
      case "transfers":
        return [
          { key: "origen", label: "Origen", type: "text", placeholder: "Ciudad o aeropuerto" },
          { key: "destino", label: "Destino", type: "text", placeholder: "Ciudad o aeropuerto" },
          { 
            key: "tipoServicio", 
      ...
      case "circuitos":
        return [
          { key: "destino", label: "Destino", type: "text", placeholder: "Ciudad o país" },
          { key: "duracion", label: "Duración mínima (días)", type: "number", min: 1 },
          { key: "precioMin", label: "Precio mínimo", type: "number", min: 0 },
          { key: "precioMax", label: "Precio máximo", type: "number", min: 0 },
        ];
      ...
      case "seguros":
        return [
          ...
          { key: "destino", label: "Destino", type: "text", placeholder: "País o región" },
          { key: "precioMax", label: "Precio máximo", type: "number", min: 0 },
        ];
      
      case "trenes":
        return [
          { key: "origen", label: "Origen", type: "text", placeholder: "Estación de salida" },
          { key: "destino", label: "Destino", type: "text", placeholder: "Estación de llegada" },
          { 
            key: "tipo", 
            label: "Tipo de tren", 
            type: "select",
          ...
          { key: "empresa", label: "Empresa", type: "text", placeholder: "Operador" },
          { 
            key: "moneda", 
            label: "Moneda", 
            type: "select",
