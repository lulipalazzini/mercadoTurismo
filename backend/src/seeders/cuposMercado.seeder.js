...
const cuposMercadoData = [
  {
    ...
    descripcion:
      "Paquete 7 días Riviera Maya - Hotel 5 estrellas con todo incluido",
    cantidad: 10,
    precioMayorista: 1200.0,
    precioMinorista: 1800.0,
    fechaVencimiento: "2026-03-15",
    observaciones:
      "Salida garantizada. Incluye vuelos, traslados y excursiones.",
    estado: "disponible",
  ...
  },
  {
    ...
    cantidad: 15,
    precioMayorista: 450.0,
    precioMinorista: 650.0,
  ...
  },
  {
    ...
    cantidad: 20,
    precioMayorista: 180.0,
    precioMinorista: 250.0,
  ...
  },
  {
    ...
    cantidad: 5,
    precioMayorista: 3200.0,
    precioMinorista: 4500.0,
    fechaVencimiento: "2026-05-20",
    observaciones:
      "Incluye hoteles 4*, desayunos, guía español. No incluye vuelos.",
    estado: "disponible",
  ...
  },
  {
    ...
    cantidad: 12,
    precioMayorista: 2800.0,
    precioMinorista: 3900.0,
  ...
  },
  {
    ...
    cantidad: 30,
    precioMayorista: 45.0,
    precioMinorista: 75.0,
  ...
  },
  {
    ...
    precioMinorista: 2100.0,
    fechaVencimiento: "2026-04-10",
    observaciones:
      "Grupo máximo 15 personas. Coordinador argentino. Hotel Manhattan.",
    estado: "disponible",
    usuarioVendedorId: 4,
  },
];
